...
- **Estatísticas e agenda (se a rede o permitir):** `https://site.api.espn.com/apis/site/v2/sports/<desporto>/<liga>/scoreboard?dates=AAAAMMDD` (ex.: `soccer/por.1`, `soccer/eng.1`, `basketball/nba`, `baseball/mlb`, `tennis/atp`) e `https://statsapi.mlb.com/api/v1/schedule?sportId=1&date=AAAA-MM-DD&hydrate=probablePitcher`.
